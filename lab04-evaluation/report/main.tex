...
\title{Lab 04 - Evaluation of results obtained from Lucene}
\location{Lausanne}
...
\include{main/2_indexing}
\include{main/3_querying}
\include{main/4_evaluation}
\include{main/5_results}
